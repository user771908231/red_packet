...
layui.define(['element', 'layer'], function (exports) {
        ...
        $.ajax({
            ...
            success: function (result, status, xhr) {
                ...
                $.each(result,function(n,value) {
                    html = html.concat(getHtml(value,n));
     ...
     * @param {Object} data
     */
    function getHtml(data,n) {
        if (n === '1'){
            var ulHtml = '<ul class="layui-nav layui-nav-tree beg-navbar" id="nav'+n+'">';
        }else{
            var ulHtml = '<ul class="layui-nav layui-nav-tree beg-navbar" id="nav'+n+'" style="display: none">';
        }
