...
func (ctx *Context) IsWxLogin() *oauth2.UserInfo {
	...
	//ret = &oauth2.UserInfo{
	//	OpenId: "oxrk0wHXKnb76Oz6Uxg_fjZzVM3o", //sapmm: oab_twdGywSq99suV8Mt14FNxxOQ wsx: oG9kZwrv8oFF9ja6WRlHxxMoJZoU 王沛：oxrk0wHXKnb76Oz6Uxg_fjZzVM3o
	//	Nickname: "王沛",
	...
	//	UnionId: "oKKIfxDEIIkZVftBs9F1Yn8hzMCg",   // 只有在用户将公众号绑定到微信开放平台帐号后，才会出现该字段。 sapmm:oKKIfxHr0Gf-36iEgKDLCJUzeqrg   wsx:oKKIfxCxJiKHLOZcOobsBzb2sl0Q 王沛：oKKIfxDEIIkZVftBs9F1Yn8hzMCg
	//}
	return ret
}
