...
func init() {
	...
	msg.Processor.SetHandler(&ddproto.PaoyaoJiabeiReq{}, game_handler.HandlerJiabeiReq)  //加倍

	msg.Processor.SetHandler(&ddproto.PaoyaoChupaiReq{}, game_handler.HandlerChupaiReq)  //出牌

	msg.Processor.SetHandler(&ddproto.PaoyaoGuopaiReq{}, game_handler.HandlerGuopaiReq)  //过牌
