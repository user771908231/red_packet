...
//		fmt.Println(" error :")
//	}
//	log.T("tZimo1fan，   番数[%v],得分[%v],描述[%v]", rfan, rscore, rhuCardStr)
//}
...
func tPinghu() {
	...
	log.T("平胡: 番数[%v],得分[%v],描述[%v]", rfan, rscore, rhuCardStr)
}
...
func tDuiDuihu() {
	...
	log.T("对对胡: 番数[%v],得分[%v],描述[%v]", rfan, rscore, rhuCardStr)
}
...
func tQingyise() {
	...
	log.T("清一色: 番数[%v],得分[%v],描述[%v]", rfan, rscore, rhuCardStr)
}
...
func tDaiyaojiu() {
	...
	log.T("带幺九: 番数[%v],得分[%v],描述[%v]", rfan, rscore, rhuCardStr)
}
...
func tQidui() {
	...
	log.T("七对: 番数[%v],得分[%v],描述[%v]", rfan, rscore, rhuCardStr)
}
...
func tQingdui() {
	...
	log.T("清对: 番数[%v],得分[%v],描述[%v]", rfan, rscore, rhuCardStr)
}
...
func tJiangdui() {
	...
	log.T("将对: 番数[%v],得分[%v],描述[%v]", rfan, rscore, rhuCardStr)
}
...
func tLongqidui() {
	...
	log.T("龙七对: 番数[%v],得分[%v],描述[%v]", rfan, rscore, rhuCardStr)
}
...
func tQingqidui() {
	...
	log.T("清七对: 番数[%v],得分[%v],描述[%v]", rfan, rscore, rhuCardStr)
}
...
func tQingyaojiu() {
	...
	log.T("清幺九: 番数[%v],得分[%v],描述[%v]", rfan, rscore, rhuCardStr)
}
...
func tQinglongqidui() {
	...
	if rfan != 6 {
		log.T("error: tQinglongqidui")
	}
	log.T("青龙七对: 番数[%v],得分[%v],描述[%v]", rfan, rscore, rhuCardStr)
}
