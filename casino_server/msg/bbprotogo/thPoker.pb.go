...
func (ETHType) EnumDescriptor() ([]byte, []int) { return fileDescriptor6, []int{0} }
...
func (ETHAction) EnumDescriptor() ([]byte, []int) { return fileDescriptor6, []int{1} }
...
func (*ThRoom) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{0} }
...
func (*THRoomAddUserBroadcast) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{1} }
...
func (*THPoker) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{2} }
...
func (*THBet) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{3} }
...
func (*THBetBegin) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{4} }
...
func (*THBetBroadcast) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{5} }
...
func (*THUser) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{6} }
...
func (*THLottery) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{7} }
...
var fileDescriptor6 = []byte{
	...
	,
}
