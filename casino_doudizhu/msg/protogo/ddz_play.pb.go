...
type DdzDoubleType int32

const (
	DdzDoubleType_JIA   DdzDoubleType = 1
	DdzDoubleType_BUJIA DdzDoubleType = 2
)

var DdzDoubleType_name = map[int32]string{
	1: "JIA",
	2: "BUJIA",
}
var DdzDoubleType_value = map[string]int32{
	"JIA":   1,
	"BUJIA": 2,
}

func (x DdzDoubleType) Enum() *DdzDoubleType {
	p := new(DdzDoubleType)
	*p = x
	return p
}
func (x DdzDoubleType) String() string {
	return proto.EnumName(DdzDoubleType_name, int32(x))
}
func (x *DdzDoubleType) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(DdzDoubleType_value, data, "DdzDoubleType")
	if err != nil {
		return err
	}
	*x = DdzDoubleType(value)
	return nil
}
func (DdzDoubleType) EnumDescriptor() ([]byte, []int) { return fileDescriptor3, []int{0} }
...
type DdzDouble struct {
	Header           *ProtoHeader   `protobuf:"bytes,1,opt,name=header" json:"header,omitempty"`
	UserId           *uint32        `protobuf:"varint,2,opt,name=userId" json:"userId,omitempty"`
	Double           *DdzDoubleType `protobuf:"varint,3,opt,name=double,enum=ddzproto.DdzDoubleType" json:"double,omitempty"`
	XXX_unrecognized []byte         `json:"-"`
}
...
func (m *DdzDouble) GetDouble() DdzDoubleType {
	if m != nil && m.Double != nil {
		return *m.Double
	}
	return DdzDoubleType_JIA
}
...
func (m *DdzDoubleAck) GetDouble() DdzDoubleType {
	if m != nil && m.Double != nil {
		return *m.Double
	}
	return DdzDoubleType_JIA
...
func (m *DdzStartPlay) GetDizhu() uint32 {
...
type DdzOutCardsAck struct {
	...
	OutCards         []*Poker     `protobuf:"bytes,5,rep,name=outCards" json:"outCards,omitempty"`
	XXX_unrecognized []byte       `json:"-"`
}
...
func (m *DdzOutCardsAck) GetOutCards() []*Poker {
	if m != nil {
		return m.OutCards
	}
	return nil
...
func init() {
	...
	proto.RegisterEnum("ddzproto.DdzDoubleType", DdzDoubleType_name, DdzDoubleType_value)
}

var fileDescriptor3 = []byte{
	// 665 bytes of a gzipped FileDescriptorProto
	,
}
